...
int main() {
    ...
    //  Free using xfree (instead of mm_free_block)
    ...
    //  Allocate another block to test reusing freed space
    ...
    //  Free p4 to test merging of free blocks
    ...
    //  Free everything related to 'another_struct'
    ...
    //  Allocate again to test if pages are reused or newly allocated
